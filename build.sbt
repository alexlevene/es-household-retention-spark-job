val proj_name = "es-household-retention-spark-job"
...
libraryDependencies += "org.elasticsearch" %% "elasticsearch-spark-20" % "5.3.2"
...
assemblyMergeStrategy in assembly <<= (assemblyMergeStrategy in assembly) { (old) =>
{
  ...
  case PathList("com", "sun", "research", "ws" , xs @ _*) => MergeStrategy.last
